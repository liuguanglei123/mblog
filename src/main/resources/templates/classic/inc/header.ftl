...
$(function () {
    ...
    var allImgs = document.getElementById("content-body").getElementsByTagName("img");
    console.log(allImgs.length);
    for (var i = 0; i < allImgs.length; i++) {
        allImgs[i].setAttribute("onclick","getClickEle(this)");
        console.log(allImgs[i].getAttribute("src"));
    }

    var allUrls = document.getElementById("content-body").getElementsByTagName("a");
    console.log(allUrls.length);
    for (var i = 0; i < allUrls.length; i++) {
        allUrls[i].setAttribute("target","_blank");
        console.log(allUrls[i].getAttribute("href"));
    }
});
</script>
<!-- Header END -->
